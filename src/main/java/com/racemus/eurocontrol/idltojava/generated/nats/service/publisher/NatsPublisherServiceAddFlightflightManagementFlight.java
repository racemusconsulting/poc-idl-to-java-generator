 ...
 * ****************************************************************************
 *
 * Automatically generated NATS publisher service for subject AddFlight::flightManagement.Flight.
 */
@Slf4j
public class NatsPublisherServiceAddFlightflightManagementFlight implements INatsPublisherServiceAddFlightflightManagementFlight {
  private final Connection natsConnection;

  public NatsPublisherServiceAddFlightflightManagementFlight(Connection natsConnection) {
    this.natsConnection = natsConnection;
  }

  @Override
  public void publishEvent(Flight dto) {
    publishEvent(this.natsConnection, "AddFlight::flightManagement.Flight", dto);
  }
